# === FIEDLER V4 DELTA ===
# Fiedler V4 Architecture Specification
...
- **CET Integration (V4+):** Fiedler's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
- **Container Requirements - Resources (UPDATED):**
  - **RAM:** 2432 MB (increased from 2048 MB)
    - V3 baseline: 2048 MB
    - CET model: +384 MB
    - Total V4: 2432 MB
...
|---|---|---|
| `FIEDLER_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/fiedler_cet_v4.onnx` |
