# === MARCO V4 DELTA ===
# Marco V4 Architecture Specification
...
- **CET Integration (V4+):** Marco's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
- **Container Requirements - Resources (UPDATED):**
  - **RAM:** 1920 MB (increased from 1536 MB)
    - V3 baseline: 1536 MB
    - CET model: +384 MB
    - Total V4: 1920 MB
...
|---|---|---|
| `MARCO_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/marco_cet_v4.onnx` |
