...
3.  **Playfair -> Dewey:** Returns the resulting ciphertext.
4.  **Dewey -> Other MAD:** Sends the ciphertext over the conversation bus.
5.  **Other MAD -> Playfair:** Receives the ciphertext and calls `decrypt(key_name='archive_transit_key', ciphertext=...)`.
