...
## 4. Interfaces
(This section is unchanged from V1)
...
### Data Contracts
The primary data structures (ACL, Secret Schema) are unchanged from V1.
...
### Logging Format
The logging format is unchanged from V1. LPPM-accelerated actions are logged identically to Imperator-driven actions, but may include an additional context field like `"source": "lppm"` for performance analysis.
