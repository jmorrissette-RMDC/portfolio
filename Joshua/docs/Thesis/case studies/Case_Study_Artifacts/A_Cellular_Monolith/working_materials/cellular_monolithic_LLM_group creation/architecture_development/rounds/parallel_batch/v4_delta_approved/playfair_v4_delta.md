# === PLAYFAIR V4 DELTA ===
# Playfair V4 Architecture Specification
...
- **CET Integration (V4+):** Playfair's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
- **Container Requirements - Resources (UPDATED):**
  - **RAM:** 896 MB (increased from 512 MB)
    - V3 baseline: 512 MB
    - CET model: +384 MB
    - Total V4: 896 MB
...
|---|---|---|
| `PLAYFAIR_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/playfair_cet_v4.onnx` |
