# === LOVELACE V4 DELTA ===
# Lovelace V4 Architecture Specification
...
- **CET Integration (V4+):** Lovelace's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
- **Container Requirements - Resources (UPDATED):**
  - **RAM:** 1408 MB (increased from 1024 MB)
    - V3 baseline: 1024 MB
    - CET model: +384 MB
    - Total V4: 1408 MB
...
|---|---|---|
| `LOVELACE_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/lovelace_cet_v4.onnx` |
