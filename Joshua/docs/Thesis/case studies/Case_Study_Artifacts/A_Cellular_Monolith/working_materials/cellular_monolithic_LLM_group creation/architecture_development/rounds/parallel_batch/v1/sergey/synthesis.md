# Sergey V1 Architecture Specification
...
- **New in this Version:** This is the initial V1 specification for Sergey. It establishes the foundational `call_api` tool and the mechanisms for securely managing service authentications. This version is strictly V1, with the Imperator responsible for interpreting requests and mapping them to the correct API calls.

## 2. Thinking Engine
- **Imperator Configuration (V1+):** Sergey's Imperator is configured to think like an integration specialist. It has knowledge of REST APIs, GraphQL, OAuth flows, and the specific schemas of the services it manages.
...
```yaml
# Tool definitions for Sergey V1
...
CREATE TABLE sergey.services (
    ...
    -- Add columns for OAuth refresh tokens, client IDs etc.
...
|---|---|---|
| `JOSHUA_MAD_NAME` | Canonical name of this MAD. | `sergey-v1` |
