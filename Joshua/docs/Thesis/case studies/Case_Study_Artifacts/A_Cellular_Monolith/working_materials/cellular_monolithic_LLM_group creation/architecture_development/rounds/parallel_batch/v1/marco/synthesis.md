# Marco V1 Architecture Specification
...
- **New in this Version:** This is the initial V1 specification for Marco. It establishes the foundational tools for browser control using a headless Chromium instance. This version is strictly V1, relying on its Imperator to translate natural language goals into concrete browser actions.

## 2. Thinking Engine
- **Imperator Configuration (V1+):** Marco's Imperator is configured to think like an expert web researcher and data scraper. It understands the structure of web pages (DOM), network requests, and how to sequence actions to achieve a goal.
...
- **Container Requirements:**
  ...
  - **Resources:**
    ...
    - **RAM:** 2 GB. Headless browsers are memory-hungry.
- **Configuration:**

| Variable | Description | Example Value |
|---|---|---|
| `JOSHUA_MAD_NAME` | Canonical name of this MAD. | `marco-v1` |
