...
- **CET Integration (V4+):** Turing's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
- **Container Requirements - Resources (UPDATED):**
  - **RAM:** 640 MB (increased from 256 MB)
    - V3 baseline: 256 MB
    - CET model: +384 MB
    - Total V4: 640 MB
...
|---|---|---|
| `TURING_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/turing_cet_v4.onnx` |
