# === MCNAMARA V4 DELTA ===
# McNamara V4 Architecture Specification
...
- **CET Integration (V4+):** McNamara's CET is a small transformer model trained on successful Imperator reasoning chains from V1/V2/V3 production. It performs context engineering to create optimal prompts for the Imperator.
...
|---|---|---|
| `MCNAMARA_CET_MODEL_PATH` | Path to the trained CET model file. | `/models/cet/mcnamara_cet_v4.onnx` |
